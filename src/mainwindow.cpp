    ...
    ui(new Ui::MainWindow)
{
    ...
    // Removido: controle de regiões críticas via UI. Agora os trens
    // sincronizam diretamente com QSemaphore dentro de Trem::run().
...
// Removidos: slots ocupaTrilho/desocupaTrilho. Sincronização é feita nas threads.
